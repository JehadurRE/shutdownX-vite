  ...
  return (
    <section className="relative py-20 md:py-28">
      <div className="mx-auto max-w-4xl px-6">
        <div className="glass rounded-3xl border border-white/10 p-10 text-center shadow-glow">
          <div className="inline-flex rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-slate-300">
            404 • Not Found
          </div>
          <h1 className="mt-4 font-display text-4xl md:text-6xl font-extrabold grad-text">Looks like this page drifted off.</h1>
